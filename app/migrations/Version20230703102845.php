 ...
 */
final class Version20230703102845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE documents (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, file VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_A2B07288166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE segment (id INT AUTO_INCREMENT NOT NULL, document_id INT NOT NULL, source_text VARCHAR(255) NOT NULL, target_text VARCHAR(255) DEFAULT NULL, source_language VARCHAR(255) NOT NULL, target_language VARCHAR(255) NOT NULL, INDEX IDX_1881F565C33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F565C33F7837 FOREIGN KEY (document_id) REFERENCES documents (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE segment DROP FOREIGN KEY FK_1881F565C33F7837');
